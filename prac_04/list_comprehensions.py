...
those_numbers = [number for number in numbers if number >9]
print(those_numbers)
...
those_names_in_string = ", ".join([name.split()[1] for name in full_names if len(name) >11])
print(those_names_in_string)